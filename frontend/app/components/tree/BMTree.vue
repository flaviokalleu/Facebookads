...
<template>
  <div class="space-y-4">
    <UiCard v-for="bm in businesses" :key="String(bm.id)">
      <details class="group">
        ...
        <ul class="mt-4 space-y-2 border-t border-border pt-4">
          ...
          <li v-if="!(bm.ad_accounts && bm.ad_accounts.length)" class="text-sm text-ink-muted px-3">
